export default {
  ...
  specializedEvent: "DIGI PAY is the specialized event for payments in the banking, financial, and investment sector.",
  platformDiscussion:
    "DIGI PAY is the platform for discussing digital banking and payment solutions, detecting and preventing fraud in real-time payments.",
  digitalPaymentsPlatform: "DIGI PAY is the platform for changing the world of money and digital payments.",
  enhancedAwareness:
    "DIGI PAY makes business for businesses, regulators to increase awareness in response to the growing expectations of consumers.",
  paymentPlatform:
    "DIGI PAY seeks strong partnership for secure and convenient digital payments in Bulgaria and Central and Eastern Europe countries.",
