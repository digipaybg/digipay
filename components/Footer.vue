...
<template>
  <div class="flex h-auto flex-col space-y-10 divide-y divide-white px-4 sm:px-10 md:px-20">
    <div class="flex w-full flex-col items-center justify-between space-y-6 sm:space-y-10 lg:flex-row lg:space-y-0">
        ...
        <div v-for="person in people" :key="person.name" class="flex flex-col gap-4 lg:flex-row lg:gap-10">
          <div class="flex flex-col items-start gap-1 sm:gap-2">
            ...
            <div v-if="person.linkedIn">
              <NuxtLink :href="person.linkedIn" target="_blank" rel="noopener noreferrer">
                <Icon
                  name="i-mdi-linkedin"
      ...
      <div class="flex flex-[0.35] flex-col items-center lg:items-start">
        ...
        <h1 class="text-center text-base sm:text-left sm:text-lg md:text-xl">
          Inter Expo Center Sofia, 147, <br />
          Tsarigradsko shose blvd
        </h1>
      </div>
    </div>
    <div class="flex flex-col items-center justify-between space-y-4 py-4 sm:flex-row sm:space-y-0 sm:py-10">
